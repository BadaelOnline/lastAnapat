...
{{--                                    <input type="hidden" name="tipos_carnet" value="{{$cur->tipo_de_curso->tipo_curso == 'Básico' ? 'B' : 'R'}}">--}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <label for="examen_t_pdf" class="col-sm-4 col-form-label">{{__('message.Examen Teórico')}}  </label> <span class="maxsize"> El tamaño máximo de archivo subido no debe superar 2 MB</span>
                    <div class="col-sm-9">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <label for="examen_p_pdf" class="col-sm-4 col-form-label">{{__('message.Examen Práctico')}}</label> <span class="maxsize"> El tamaño máximo de archivo subido no debe superar 2 MB</span>
                    <div class="col-sm-9">

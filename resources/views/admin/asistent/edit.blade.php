...
@section('content')
    ...
    <form action="{{ route('admin.asistent.update',$asistent->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-groups">
            ...
            {{--fourth row--}}
            <div class="form-group col-md-4">
                <label for="examen_t_pdf" class="col-sm-4 col-form-label">{{__('message.Examen Teórico')}}</label>
            ...
            <div class="form-group col-md-4">
                <label for="examen_p_pdf" class="col-sm-4 col-form-label">{{__('message.Examen Práctico')}}</label>
                <span class="maxsize"> El tamaño máximo de archivo subido no debe superar 2 MB</span>

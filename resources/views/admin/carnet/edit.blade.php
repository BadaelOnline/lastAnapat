    ...
    <form action="{{ route('admin.carnet.update',$carnet->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-groups">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-9">
                    <input type="text" name='tipos_de_pemp' class="form-control {{$errors->first('tipos_de_pemp') ? "is-invalid" : "" }} " value="{{old('tipos_de_pemp') ? old('tipos_de_pemp') : $carnet->tipos_de_pemp}}" id="tipos_de_pemp" placeholder="Tipos De Pemp">
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <div class="col-sm-9">
                    <select name='examen_teorico_realizado' class="form-control {{$errors->first('examen_teorico_realizado') ? "is-invalid" : "" }} " id="examen_teorico_realizado">
                        ...
                        <option value="básico" {{$carnet->examen_teorico_realizado == "básico" ? "selected" : ""}}>Básico</option>
                        <option value="Extendido" {{$carnet->examen_teorico_realizado == "Extendido" ? "selected" : ""}}>Extendido</option>
